...
typedef struct 
{
	int tradingSize;
	int hedgeSize;
	Param_band m_Param[6];
}Parameter_band;

typedef struct
{
	mdPrice_band pre_price;
	mdPrice_band cur_price;
	...
	double tick_open_price;
	double tick_min_price;
	double tick_max_price;
	double tick_cur_num;
	double tick_open_volume;
...
bool IsCloseTime(double middle_val,double sd_val,double rsi_val,Parameter_band *param,
