...
void CHyArbitrageVolumeTrendOther3::clearVector()
{
	...
	Parameter_band param_trigger;
	memcpy(&param_trigger,param,sizeof(Parameter_band));
...
bool CHyArbitrageVolumeTrendOther3::get_fv(SThreadChannel *threadChannel,double &fv)
{
	...
	memcpy(&volumeTrendInfo->cur_price,&cur_price,sizeof(mdPrice_band));
	memcpy(&volumeTrendInfo->pre_price,&pre_price,sizeof(mdPrice_band));
