#include "BandAndTriggerSizeFeedFun.h"
...
bool IsOpenTime(double middle_val,double sd_val,double rsival,Parameter *param,VolumeTrendOther3Info *info,int param_index){
	//band_open_noraml
