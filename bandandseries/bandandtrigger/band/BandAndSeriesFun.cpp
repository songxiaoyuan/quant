...
bool IsOpenTime(double middle_val,double sd_val,Parameter_series *param,VolumeTrendSeriesInfo *info,int param_index){
	...
	int limit_multiple = ((double)param->m_Param[param_index+1].spread)/10;
	int bar_tick = param->m_Param[param_index].spread;
	int limit_large_period = param->m_Param[param_index].openEdge;
...
bool IsCloseTime(double middle_val,double sd_val,double rsi_val,Parameter_series *param,VolumeTrendSeriesInfo *info,int param_index){
	...
	double limit_sd_profit_edge =  ((double)param->m_Param[param_index+1].orderDelay)/10;
